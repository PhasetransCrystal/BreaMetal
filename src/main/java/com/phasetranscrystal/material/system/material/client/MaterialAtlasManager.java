...
public class MaterialAtlasManager extends TextureAtlasHolder {
    ...
    public static final ResourceLocation MATERIAL_SHEET = ResourceLocation.fromNamespaceAndPath(BreaMaterials.MODID, "textures/atlas/material.png");
    public static final ResourceLocation MATERIAL_ATLAS = ResourceLocation.fromNamespaceAndPath(BreaMaterials.MODID, "material");
...
//                                                f = SpriteHelper.blend(f,images.get(2));
    ...
    public static ResourceLocation combine(Material material,MaterialItemType type){
        return ResourceLocation.fromNamespaceAndPath(material.id.getNamespace() + "_" + type.id.getNamespace(),material.id.getPath() + "_" + type.id.getPath());
    }
